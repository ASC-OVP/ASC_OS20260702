...
import { createStickyMemoAction } from "@/features/memos/actions/memoActions";
import {
...
const primaryButton: CSSProperties = { height: 30, border: 0, borderRadius: "var(--asc-radius-md)", background: "var(--asc-text)", color: "var(--asc-bg)", padding: "0 10px", fontSize: 12, fontWeight: 950 };
const colorRow: CSSProperties = { display: "flex", gap: 5, alignItems: "center", flexWrap: "wrap" };
const swatchLabel: CSSProperties = { display: "inline-grid", placeItems: "center", cursor: "pointer", borderRadius: "var(--asc-radius-sm)" };
