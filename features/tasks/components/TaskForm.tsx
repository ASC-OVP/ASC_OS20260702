...
const assigneeField: CSSProperties = { border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", padding: 12, background: "var(--asc-bg-subtle)" };
const assigneeGrid: CSSProperties = { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(150px, 1fr))", gap: 8, marginTop: 8 };
const checkChip: CSSProperties = { display: "grid", gridTemplateColumns: "auto 1fr auto", alignItems: "center", gap: 8, border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", padding: "9px 10px", background: "var(--asc-surface)", fontSize: 13, boxShadow: "var(--asc-shadow-sm)" };
