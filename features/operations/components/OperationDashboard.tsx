...
const primaryButton: CSSProperties = { background: "var(--asc-primary)", color: "#fff", border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", padding: "8px 11px", textDecoration: "none", fontWeight: 950 };
const secondaryButton: CSSProperties = { background: "var(--asc-bg-subtle)", color: "var(--asc-text)", border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", padding: "8px 11px", textDecoration: "none", fontWeight: 950 };
...
const shortcut: CSSProperties = { border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", padding: "9px 10px", textDecoration: "none", color: "var(--asc-text)", fontWeight: 900, background: "var(--asc-bg-subtle)" };
const logTableWrap: CSSProperties = { overflow: "auto", border: "1px solid transparent", borderRadius: "var(--asc-radius-lg)", background: "var(--asc-surface)" };
const table: CSSProperties = { width: "100%", borderCollapse: "collapse", fontSize: 13 };
const th: CSSProperties = { position: "sticky", top: 0, textAlign: "left", background: "var(--asc-bg-subtle)", padding: "8px 9px", borderBottom: "1px solid var(--asc-row-divider)", color: "var(--asc-text-subtle)", fontSize: 12, fontWeight: 950, whiteSpace: "nowrap" };
const td: CSSProperties = { padding: "8px 9px", borderBottom: "1px solid var(--asc-row-divider)", verticalAlign: "top" };
const emptyTd: CSSProperties = { ...td, textAlign: "center", color: "var(--asc-text-muted)", padding: 14 };
const badge: CSSProperties = { display: "inline-flex", alignItems: "center", borderRadius: "var(--asc-radius-md)", background: "var(--asc-primary-soft)", color: "var(--asc-primary-hover)", padding: "3px 7px", fontWeight: 900, whiteSpace: "nowrap" };
