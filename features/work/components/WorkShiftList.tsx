...
const assistantPanel: CSSProperties = { background: "var(--asc-surface)", border: surfaceBorder, borderRadius: "var(--asc-radius-lg)", padding: 10, position: "sticky", top: 10, boxShadow: "var(--asc-shadow-sm)" };
...
const settlementPanel: CSSProperties = { background: "var(--asc-surface)", border: surfaceBorder, borderRadius: "var(--asc-radius-lg)", padding: 10, display: "grid", gap: 9, boxShadow: "var(--asc-shadow-sm)" };
const tablePanel: CSSProperties = { background: "var(--asc-surface)", border: surfaceBorder, borderRadius: "var(--asc-radius-lg)", padding: 10, display: "grid", gap: 9, boxShadow: "var(--asc-shadow-sm)" };
const calendarPanel: CSSProperties = { background: "var(--asc-surface)", border: surfaceBorder, borderRadius: "var(--asc-radius-lg)", padding: 10, display: "grid", gap: 9, boxShadow: "var(--asc-shadow-sm)" };
...
const sideWorkPane: CSSProperties = { border: surfaceBorder, borderRadius: "var(--asc-radius-lg)", padding: 10, background: "var(--asc-surface)", display: "grid", gap: 9, alignContent: "start", boxShadow: "var(--asc-shadow-sm)" };
