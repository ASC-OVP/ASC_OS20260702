      ...
      <section style={container}>
        <div style={header}>
          <PageHeader
            ...
            actions={<div style={monthTools} className="asc-action-group">
...
const header: CSSProperties = { display: "flex", justifyContent: "space-between", alignItems: "flex-end", gap: 10, background: "transparent", border: 0, borderRadius: 0, padding: "0 2px 2px", flexWrap: "wrap", boxShadow: "none" };
...
const assistantPanel: CSSProperties = { background: "var(--asc-surface)", border: "1px solid transparent", borderRadius: "var(--asc-radius-lg)", padding: 10, position: "sticky", top: 10, boxShadow: "var(--asc-shadow-sm)" };
const assistantList: CSSProperties = { display: "grid", gap: 6 };
const assistantLink: CSSProperties = { display: "grid", gap: 3, border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", padding: 8, color: "var(--asc-text)", textDecoration: "none", background: "var(--asc-bg-subtle)" };
const activeAssistantLink: CSSProperties = { ...assistantLink, background: "var(--asc-primary-soft)", boxShadow: "inset 3px 0 0 var(--asc-primary)" };
const mainColumn: CSSProperties = { display: "grid", gap: 10, minWidth: 0 };
const settlementPanel: CSSProperties = { background: "var(--asc-surface)", border: "1px solid transparent", borderRadius: "var(--asc-radius-lg)", padding: 10, display: "grid", gap: 9, boxShadow: "var(--asc-shadow-sm)" };
const tablePanel: CSSProperties = { background: "var(--asc-surface)", border: "1px solid transparent", borderRadius: "var(--asc-radius-lg)", padding: 10, display: "grid", gap: 9, boxShadow: "var(--asc-shadow-sm)" };
const calendarPanel: CSSProperties = { background: "var(--asc-surface)", border: "1px solid transparent", borderRadius: "var(--asc-radius-lg)", padding: 10, display: "grid", gap: 9, boxShadow: "var(--asc-shadow-sm)" };
...
const summaryCard: CSSProperties = { border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", padding: 9, display: "grid", gap: 4, background: "var(--asc-bg-subtle)" };
const moneyCard: CSSProperties = { background: "var(--asc-success-soft)" };
const warnCard: CSSProperties = { background: "var(--asc-warning-soft)" };
const successCard: CSSProperties = { background: "var(--asc-success-soft)" };
const settlementNotice: CSSProperties = { margin: 0, border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", padding: 10, background: "var(--asc-bg-subtle)", color: "var(--asc-text-subtle)", fontSize: 13, fontWeight: 800 };
const settlementActionBox: CSSProperties = { border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", padding: 9, background: "var(--asc-bg-subtle)", display: "grid", gap: 7 };
...
const tableWrap: CSSProperties = { overflow: "auto", border: "1px solid var(--asc-border-subtle)", borderRadius: "var(--asc-radius-md)" };
const workTable: CSSProperties = { width: "100%", minWidth: 980, borderCollapse: "collapse", fontSize: 13 };
const th: CSSProperties = { position: "sticky", top: 0, padding: "8px 9px", borderBottom: "1px solid var(--asc-border-subtle)", background: "var(--asc-bg-subtle)", textAlign: "left", color: "var(--asc-text-subtle)", fontSize: 12, fontWeight: 950, whiteSpace: "nowrap" };
const td: CSSProperties = { padding: "8px 9px", borderBottom: "1px solid var(--asc-border-subtle)", verticalAlign: "middle", whiteSpace: "nowrap" };
...
const warnPill: CSSProperties = { display: "inline-flex", borderRadius: "var(--asc-radius-md)", padding: "3px 7px", background: "var(--asc-warning-soft)", color: "var(--asc-warning-text)", fontSize: 12, fontWeight: 900 };
const calendarWrap: CSSProperties = { display: "grid", gap: 0, border: "1px solid var(--asc-border-subtle)", borderRadius: "var(--asc-radius-md)", overflow: "hidden" };
const weekdayRow: CSSProperties = { display: "grid", gridTemplateColumns: "repeat(7, minmax(74px, 1fr))", background: "var(--asc-bg-subtle)", borderBottom: "1px solid var(--asc-border-subtle)", textAlign: "center", fontWeight: 950, color: "var(--asc-text-muted)", fontSize: 12 };
const calendarGrid: CSSProperties = { display: "grid", gridTemplateColumns: "repeat(7, minmax(74px, 1fr))" };
const calendarDay: CSSProperties = { minHeight: 76, borderRight: "1px solid var(--asc-border-subtle)", borderBottom: "1px solid var(--asc-border-subtle)", padding: 5, display: "grid", gridTemplateRows: "auto 1fr auto", gap: 3, color: "var(--asc-text)", textDecoration: "none", background: "var(--asc-surface)" };
...
const shiftChip: CSSProperties = { display: "block", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", borderRadius: "var(--asc-radius-sm)", padding: "3px 5px", background: "var(--asc-primary-soft)", color: "var(--asc-primary)", fontSize: 11, fontWeight: 900 };
const absentChip: CSSProperties = { ...shiftChip, background: "var(--asc-danger-soft)", color: "var(--asc-danger)" };
const cancelledChip: CSSProperties = { ...shiftChip, background: "var(--asc-bg-subtle)", color: "var(--asc-text-muted)" };
const moreChip: CSSProperties = { color: "var(--asc-text-muted)", fontSize: 13, fontWeight: 950, textAlign: "center" };
const dayPayText: CSSProperties = { color: "var(--asc-text-muted)", textAlign: "right", fontSize: 12, fontWeight: 950 };
const sundayText: CSSProperties = { color: "var(--asc-danger)" };
const saturdayText: CSSProperties = { color: "var(--asc-info)" };
...
const sideWorkPane: CSSProperties = { border: "1px solid transparent", borderRadius: "var(--asc-radius-lg)", padding: 10, background: "var(--asc-surface)", display: "grid", gap: 9, alignContent: "start", boxShadow: "var(--asc-shadow-sm)" };
...
const assistantMemoBox: CSSProperties = { border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", padding: 9, background: "var(--asc-primary-soft)", display: "grid", gap: 8 };
const assistantMemoForm: CSSProperties = { display: "grid", gap: 6 };
const memoTextarea: CSSProperties = { width: "100%", resize: "vertical", minHeight: 72, border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", padding: 8, background: "var(--asc-bg-subtle)", color: "var(--asc-text)", lineHeight: 1.45 };
...
const input: CSSProperties = { width: "100%", height: 36, border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", padding: "0 9px", background: "var(--asc-bg-subtle)", color: "var(--asc-text)", boxSizing: "border-box" };
...
const smallPrimaryButton: CSSProperties = { height: 36, border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", background: "var(--asc-primary)", color: "#fff", padding: "0 10px", fontSize: 12, fontWeight: 950 };
const smallGhost: CSSProperties = { ...primaryButton, background: "var(--asc-bg-subtle)", color: "var(--asc-text)" };
const smallGhostLink: CSSProperties = { height: 36, display: "inline-flex", alignItems: "center", justifyContent: "center", border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", background: "var(--asc-bg-subtle)", color: "var(--asc-text)", padding: "0 10px", textDecoration: "none", fontSize: 12, fontWeight: 950, whiteSpace: "nowrap" };
const dangerButton: CSSProperties = { ...primaryButton, background: "var(--asc-danger)" };
const successButton: CSSProperties = { ...primaryButton, background: "var(--asc-success)" };
const badge: CSSProperties = { display: "inline-flex", alignItems: "center", height: 24, borderRadius: "var(--asc-radius-md)", background: "var(--asc-bg-subtle)", color: "var(--asc-text-subtle)", padding: "0 8px", fontSize: 12, fontWeight: 950, whiteSpace: "nowrap" };
...
const empty: CSSProperties = { border: "1px dashed var(--asc-border-subtle)", borderRadius: "var(--asc-radius-md)", padding: 12, textAlign: "center", color: "var(--asc-text-muted)", fontWeight: 900, background: "var(--asc-bg-subtle)" };
