...
const badge: CSSProperties = { width: "fit-content", border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", background: "var(--asc-info-soft)", color: "var(--asc-info)", padding: "5px 8px", fontWeight: 950 };
...
const ruleRow: CSSProperties = { display: "flex", justifyContent: "space-between", alignItems: "center", gap: 8, border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", background: "var(--asc-bg-subtle)", padding: 9, color: "var(--asc-text-subtle)" };
