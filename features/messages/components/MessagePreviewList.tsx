...
const summaryCard: CSSProperties = { border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", background: "var(--asc-bg-subtle)", padding: 8, display: "grid", gap: 3, color: "var(--asc-text-subtle)", fontSize: 12, fontWeight: 800 };
const summaryWarn: CSSProperties = { background: "var(--asc-warning-soft)", color: "var(--asc-warning-text)" };
const warningBox: CSSProperties = { border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", background: "var(--asc-warning-soft)", color: "var(--asc-warning-text)", padding: 8, fontWeight: 900, fontSize: 12 };
const tableWrap: CSSProperties = { overflow: "auto", border: "1px solid transparent", borderRadius: "var(--asc-radius-lg)", background: "var(--asc-surface)", boxShadow: "var(--asc-shadow-sm)", maxHeight: 260 };
const table: CSSProperties = { width: "100%", borderCollapse: "collapse", fontSize: 12 };
const th: CSSProperties = { position: "sticky", top: 0, background: "var(--asc-bg-subtle)", borderBottom: "1px solid var(--asc-row-divider)", padding: "8px 9px", textAlign: "left", whiteSpace: "nowrap", fontWeight: 950 };
const td: CSSProperties = { borderBottom: "1px solid var(--asc-row-divider)", padding: "8px 9px", whiteSpace: "nowrap", verticalAlign: "top", cursor: "pointer" };
...
const details: CSSProperties = { border: "1px solid transparent", borderRadius: "var(--asc-radius-lg)", padding: 8, background: "var(--asc-bg-subtle)" };
...
const skipPill: CSSProperties = { border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", background: "var(--asc-warning-soft)", color: "var(--asc-warning-text)", padding: "5px 8px", fontSize: 12, fontWeight: 850 };
