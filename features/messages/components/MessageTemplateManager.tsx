...
function filterLink(active: boolean): CSSProperties {
  return {
    ...
    background: active ? "var(--asc-primary)" : "var(--asc-bg-subtle)",
...
const activeBadge: CSSProperties = { borderRadius: "var(--asc-radius-md)", background: "var(--asc-success-soft)", color: "var(--asc-success)", padding: "5px 8px", fontSize: 12, fontWeight: 950 };
const inactiveBadge: CSSProperties = { ...activeBadge, background: "var(--asc-bg-subtle)", color: "var(--asc-text-muted)" };
const previewBox: CSSProperties = { marginTop: 8, border: "1px solid transparent", borderRadius: "var(--asc-radius-lg)", background: "var(--asc-surface)", padding: 8, display: "grid", gap: 4 };
