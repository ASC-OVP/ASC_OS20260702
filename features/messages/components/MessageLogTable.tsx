...
const filterBar: CSSProperties = { display: "grid", gridTemplateColumns: "150px 150px 150px 180px minmax(160px, 1fr) 90px 80px", gap: 6, alignItems: "center", border: "1px solid transparent", borderRadius: "var(--asc-radius-lg)", background: "var(--asc-bg-subtle)", padding: 8 };
const input: CSSProperties = { height: 34, border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", background: "var(--asc-surface)", color: "var(--asc-text)", padding: "0 9px", minWidth: 0 };
const checkLabel: CSSProperties = { display: "inline-flex", alignItems: "center", gap: 6, fontWeight: 900, color: "var(--asc-text-subtle)" };
const filterButton: CSSProperties = { height: 34, border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", background: "var(--asc-primary)", color: "#fff", fontWeight: 950 };
...
const td: CSSProperties = { borderBottom: "1px solid var(--asc-row-divider)", padding: "8px 9px", whiteSpace: "nowrap", verticalAlign: "top" };
...
const detailBox: CSSProperties = { marginTop: 8, display: "grid", gap: 5, border: "1px solid transparent", borderRadius: "var(--asc-radius-lg)", background: "var(--asc-bg-subtle)", padding: 10, whiteSpace: "pre-wrap" };
