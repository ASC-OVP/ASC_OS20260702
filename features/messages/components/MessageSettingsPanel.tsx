...
const card: CSSProperties = { border: "1px solid transparent", borderRadius: "var(--asc-radius-lg)", background: "var(--asc-bg-subtle)", padding: 10, display: "grid", gap: 3, color: "var(--asc-text-subtle)", fontWeight: 900 };
const notice: CSSProperties = { border: "1px solid transparent", borderRadius: "var(--asc-radius-lg)", background: "var(--asc-warning-soft)", color: "var(--asc-warning-text)", padding: 10, fontWeight: 900 };
const successNotice: CSSProperties = { border: "1px solid transparent", borderRadius: "var(--asc-radius-lg)", background: "var(--asc-success-soft)", color: "var(--asc-success)", padding: 10, fontWeight: 900 };
const dangerNotice: CSSProperties = { border: "1px solid transparent", borderRadius: "var(--asc-radius-lg)", background: "var(--asc-danger-soft)", color: "var(--asc-danger)", padding: 10, fontWeight: 900 };
const infoBox: CSSProperties = { border: "1px solid transparent", borderRadius: "var(--asc-radius-lg)", background: "var(--asc-info-soft)", color: "var(--asc-info)", padding: 10, fontWeight: 900 };
const panel: CSSProperties = { border: "1px solid transparent", borderRadius: "var(--asc-radius-lg)", background: "var(--asc-surface)", padding: 10, display: "grid", gap: 10, boxShadow: "var(--asc-shadow-sm)" };
...
const input: CSSProperties = { width: "100%", height: 36, border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", padding: "0 10px", background: "var(--asc-bg-subtle)", color: "var(--asc-text)" };
...
const primaryButton: CSSProperties = { height: 36, border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", background: "var(--asc-primary)", color: "#fff", padding: "0 14px", fontWeight: 950 };
const secondaryButton: CSSProperties = { ...primaryButton, background: "var(--asc-primary-soft)", color: "var(--asc-primary)" };
