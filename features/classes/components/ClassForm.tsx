...
const assistantBox: CSSProperties = { border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", background: "var(--asc-bg-subtle)", padding: "10px 12px" };
...
const assistantChip: CSSProperties = { display: "inline-flex", alignItems: "center", gap: 6, border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", background: "var(--asc-surface)", padding: "6px 10px", fontSize: 13, fontWeight: 800, boxShadow: "var(--asc-shadow-sm)" };
