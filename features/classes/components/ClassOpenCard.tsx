  ...
  return (
    ...
    >
      <div style={topRow}>
        ...
        <span style={{ ...statusBadge, color: statusTone }}>{statusLabel}</span>
      </div>
...
const statusBadge: CSSProperties = { display: "inline-flex", border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", padding: "5px 8px", fontSize: 12, fontWeight: 950, background: "var(--asc-bg-subtle)", whiteSpace: "nowrap" };
const infoGrid: CSSProperties = { display: "grid", gridTemplateColumns: "repeat(2, minmax(0, 1fr))", gap: 6 };
const infoItem: CSSProperties = { display: "grid", gap: 3, border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", background: "var(--asc-bg-subtle)", padding: "7px 8px", minWidth: 0, fontSize: 12 };
const lessonBox: CSSProperties = { display: "grid", gap: 3, border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", background: "var(--asc-primary-soft)", color: "var(--asc-primary-hover)", padding: "8px 9px", fontSize: 12 };
