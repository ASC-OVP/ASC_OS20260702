...
import { gradeOmrAction } from "@/features/omr/actions/gradingActions";
...
import { ExamResultStatus, OmrAnswerStatus, OmrTemplateType } from "@prisma/client";
...
const reviewStudentMeta: CSSProperties = { minWidth: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", fontSize: 11, color: "var(--asc-text-muted)", fontWeight: 800 };
const studentStatusBadge: CSSProperties = { display: "inline-flex", alignItems: "center", justifyContent: "center", minWidth: 32, height: 19, borderRadius: "var(--asc-radius-md)", padding: "0 6px", fontSize: 10, fontWeight: 950 };
