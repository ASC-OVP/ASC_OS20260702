...
const sheetSection: CSSProperties = { border: "1px solid transparent", borderRadius: "var(--asc-radius-lg)", background: "var(--asc-surface)", padding: 10, marginBottom: 10, boxShadow: "var(--asc-shadow-sm)" };
...
const sidePane: CSSProperties = { border: "1px solid transparent", borderRadius: "var(--asc-radius-lg)", padding: 10, position: "sticky", top: 12, display: "grid", gap: 8, background: "var(--asc-surface)", boxShadow: "var(--asc-shadow-sm)" };
const tableWrap: CSSProperties = { overflow: "auto", border: "1px solid transparent", borderRadius: "var(--asc-radius-lg)", maxHeight: "min(620px, calc(100vh - 310px))", background: "var(--asc-surface)", boxShadow: "var(--asc-shadow-sm)" };
...
const td: CSSProperties = { padding: "8px 9px", borderBottom: "1px solid var(--asc-row-divider)", verticalAlign: "top", whiteSpace: "nowrap" };
...
const field: CSSProperties = { display: "grid", gap: 4, fontSize: 12, fontWeight: 900, color: "var(--asc-text-subtle)" };
