...
const input: CSSProperties = { width: "100%", boxSizing: "border-box", border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", background: "var(--asc-bg-subtle)", color: "var(--asc-text)", padding: "8px 9px", fontSize: 13, minWidth: 0 };
const primaryButton: CSSProperties = { border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", background: "var(--asc-primary)", color: "#fff", padding: "9px 11px", fontWeight: 900, fontSize: 13, cursor: "pointer" };
const fileList: CSSProperties = { display: "grid", gap: 6, border: "1px solid transparent", borderRadius: "var(--asc-radius-lg)", padding: 8, background: "var(--asc-bg-subtle)" };
const fileListHead: CSSProperties = { display: "flex", justifyContent: "space-between", color: "var(--asc-text-subtle)", fontSize: 12 };
const fileRow: CSSProperties = { display: "grid", gridTemplateColumns: "minmax(0, 1fr) 72px", gap: 6, alignItems: "center", fontSize: 12 };
const fileName: CSSProperties = { overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", color: "var(--asc-text)", fontWeight: 800 };
const hintText: CSSProperties = { margin: 0, color: "var(--asc-text-muted)", fontSize: 12, lineHeight: 1.45 };
const dangerText: CSSProperties = { margin: 0, color: "var(--asc-danger)", fontSize: 12, fontWeight: 800 };
