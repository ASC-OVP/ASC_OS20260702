...
const zoomText: CSSProperties = { color: "var(--asc-text-muted)", fontSize: 12, fontWeight: 900, marginRight: "auto" };
const toolButton: CSSProperties = { border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", background: "var(--asc-bg-subtle)", color: "var(--asc-text)", padding: "6px 8px", fontSize: 12, fontWeight: 900, cursor: "pointer" };
const openLink: CSSProperties = { ...toolButton, color: "var(--asc-primary-hover)", textDecoration: "none" };
const viewport: CSSProperties = { height: 620, overflow: "auto", border: "1px solid transparent", borderRadius: "var(--asc-radius-lg)", background: "var(--asc-bg-subtle)", boxShadow: "var(--asc-shadow-sm)" };
const scaledContent: CSSProperties = { transformOrigin: "top left", transition: "transform .12s ease" };
const image: CSSProperties = { width: "100%", display: "block", background: "var(--asc-surface)" };
const pdf: CSSProperties = { width: "100%", height: "100%", border: 0, background: "var(--asc-surface)" };
const emptyBox: CSSProperties = { border: "1px dashed var(--asc-border-subtle)", borderRadius: "var(--asc-radius-lg)", padding: 16, textAlign: "center", color: "var(--asc-text-muted)", background: "var(--asc-bg-subtle)", display: "grid", gap: 6 };
