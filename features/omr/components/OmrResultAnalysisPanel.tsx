...
const analysisPanel: CSSProperties = { border: "1px solid transparent", borderRadius: "var(--asc-radius-lg)", background: "var(--asc-bg-subtle)", padding: 10, minWidth: 0 };
...
const meterTrack: CSSProperties = { height: 7, borderRadius: "var(--asc-radius-md)", background: "var(--asc-bg-subtle)", overflow: "hidden" };
const meterFill: CSSProperties = { display: "block", height: "100%", borderRadius: "var(--asc-radius-md)", background: "var(--asc-primary)" };
...
const wrongPill: CSSProperties = { border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", background: "var(--asc-danger-soft)", color: "var(--asc-danger)", padding: "4px 7px", fontSize: 12, fontWeight: 900 };
const recommendationList: CSSProperties = { display: "grid", gap: 6 };
const recommendationItem: CSSProperties = { border: "1px solid transparent", borderRadius: "var(--asc-radius-md)", background: "var(--asc-surface)", padding: 8, display: "grid", gap: 3, fontSize: 12 };
