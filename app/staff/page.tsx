...
const card: CSSProperties = { margin: 0, border: "1px solid transparent", boxShadow: "var(--asc-shadow-sm)" };
...
const tableWrap: CSSProperties = { overflow: "auto", padding: 0, border: "1px solid transparent", boxShadow: "var(--asc-shadow-sm)" };
const table: CSSProperties = { width: "100%", borderCollapse: "collapse", minWidth: 760 };
const th: CSSProperties = { textAlign: "left", padding: "9px 12px", borderBottom: "1px solid var(--asc-row-divider)", background: "var(--asc-bg-subtle)", color: "var(--asc-text-subtle)", fontSize: 12, fontWeight: 950, whiteSpace: "nowrap", position: "sticky", top: 0, zIndex: 1 };
const td: CSSProperties = { padding: "9px 12px", borderBottom: "1px solid var(--asc-row-divider)", verticalAlign: "middle", fontSize: 13 };
